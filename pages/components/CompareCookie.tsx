...
export const CompareCookie = () => {
  ...
  const sameSiteChange = (event: any) => {
  ...
  return (
    <div className={styles.wholeContainer}>
      <div className={styles.howToUse}>
        ...
        <p>
          {' '}
          Input a website with or without "http/https" as prefix. You can also include prefix
          example: ".com". Then input a path for example /documents.{' '}
        </p>
          ...
          <div className={styles.result}>
            ...
            <div className={styles.textResult}>
              <div className={styles.sameSiteResult}>
                {selectSameSite === 'none' && (
                  <p>
                    This is the default behavior for cookies, and it means that the cookie can be
                    sent with both same-site and cross-site requests.
                  </p>
                )}
                {selectSameSite === 'lax' && (
                  <p>
                    This value is similar to Strict, but with a few exceptions. Lax allows some
                    cross-site requests to include the cookie, but only if they are "safe" requests,
                    such as clicking a link or loading an image. POST requests, for example, would
                    not include the cookie.{' '}
                  </p>
                )}
                {selectSameSite === 'strict' && (
                  <p>
                    This value instructs the browser to only send the cookie with same-site
                    requests. Cross-site requests will not include the cookie.
                  </p>
                )}
              </div>
            </div>
